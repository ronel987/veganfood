...
class SidevarHome extends Component {
  render() {
    return (
      <div className="col-3">
        <div className="card bg-warning">
          <div className="text-center py-5">
            <Image src="/pizza.jpg" alt="" width="250" height="200" />
            <div className="text-light py-3">
              <h2>D'Panas Pizza</h2>
            </div>
            <div className="text-dark py-3">
              <h5>Av Grau #1865</h5>
              <h5>10:00 am a 10:00 pm</h5>
              <h5>Celular: 947586982</h5>
            </div>
            <div className="text-light py-3">
